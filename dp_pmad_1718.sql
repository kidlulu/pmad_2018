...
update pmad2018.tmp2 set D05 = 39 where A01nficha = 685 and D01 = 2276;
update pmad2018.tmp2 set D05 = 27 where A01nficha = 853 and D01 = 2819;
update pmad2018.tmp2 set D05 = 57 where A01nficha = 1298 and D01 = 4246;
update pmad2018.tmp2 set D05 = 44 where A01nficha = 1543 and D01 = 5019;
update pmad2018.tmp2 set D05 = 40 where A01nficha = 1575 and D01 = 5122;
update pmad2018.tmp2 set D02 = 2 where A01nficha = 1670 and D01 = 5434;
update pmad2018.tmp2 set D05 = 32 where A01nficha = 1716 and D01 = 5593;
update pmad2018.tmp2 set D05 = 29 where A01nficha = 1884 and D01 = 6174;
update pmad2018.tmp2 set D05 = 34 where A01nficha = 2063 and D01 = 6865;
update pmad2018.tmp2 set D05 = 57 where A01nficha = 2085 and D01 = 6936;
update pmad2018.tmp2 set D05 = 51 where A01nficha = 2085 and D01 = 6933;
update pmad2018.tmp2 set D05 = 49 where A01nficha = 2099 and D01 = 6977;
update pmad2018.tmp2 set D05 = 36 where A01nficha = 2245 and D01 = 7508;
update pmad2018.tmp2 set D05 = 34 where A01nficha = 2476 and D01 = 8245;
update pmad2018.tmp2 set D05 = 38 where A01nficha = 3779 and D01 = 12243;
update pmad2018.tmp2 set D05 = 56 where A01nficha = 3884 and D01 = 12590;
update pmad2018.tmp2 set D05 = 33 where A01nficha = 3943 and D01 = 12798;
update pmad2018.tmp2 set D05 = 43 where A01nficha = 4348 and D01 = 14144;
update pmad2018.tmp2 set D05 = 38 where A01nficha = 4710 and D01 = 15388;
update pmad2018.tmp2 set D05 = 35 where A01nficha = 4806 and D01 = 15688;
update pmad2018.tmp2 set D05 = 53 where A01nficha = 5139 and D01 = 16751;
update pmad2018.tmp2 set D05 = 24, D15 = 24 where A01nficha = 5344 and D01 = 17426;
update pmad2018.tmp2 set D05 = 41 where A01nficha = 5881 and D01 = 19189;
update pmad2018.tmp2 set D05 = 41 where A01nficha = 6090 and D01 = 19862;
update pmad2018.tmp2 set D05 = 39 where A01nficha = 6583 and D01 = 21352;
update pmad2018.tmp2 set D05 = 47 where A01nficha = 7485 and D01 = 24317;
update pmad2018.tmp2 set D05 = 32, D15 = 32 where A01nficha = 7590 and D01 = 24690;
update pmad2018.tmp2 set D05 = 34 where A01nficha = 7621 and D01 = 24787;
update pmad2018.tmp2 set D05 = 34 where A01nficha = 8320 and D01 = 26905;
update pmad2018.tmp2 set D05 = 39 where A01nficha = 8454 and D01 = 27305;
update pmad2018.tmp2 set D05 = 33 where A01nficha = 8171 and D01 = 26423;
update pmad2018.tmp2 set D05 = 52 where A01nficha = 9158 and D01 = 29575;
update pmad2018.tmp2 set D05 = 39 where A01nficha = 9594 and D01 = 31033;
update pmad2018.tmp2 set D05 = 35 where A01nficha = 9630 and D01 = 31130;
update pmad2018.tmp2 set D05 = 42 where A01nficha = 9769 and D01 = 31581;
update pmad2018.tmp2 set D05 = 28 where A01nficha = 9782 and D01 = 31631;
update pmad2018.tmp2 set D05 = 32 where A01nficha = 10257 and D01 = 33069;
update pmad2018.tmp2 set D05 = 39 where A01nficha = 10516 and D01 = 33829;
update pmad2018.tmp2 set D05 = 34 where A01nficha = 10802 and D01 = 34729;
...
/*Correção de número de pessoas*/
update pmad2018.dp_dom_1718_imput set A01npessoas = 5 where A01nficha = 4941;
update pmad2018.dp_dom_1718_imput set A01npessoas = 2 where A01nficha = 6422;
update pmad2018.dp_mor_1718 set A01npessoas = 5 where A01nficha = 4941;
update pmad2018.dp_mor_1718 set A01npessoas = 2 where A01nficha = 6422;
update pmad.dom20172018 set A01npessoas = 5 where A01nficha = 4941;
update pmad.dom20172018 set A01npessoas = 2 where A01nficha = 6422;
...
update pmad2018.dp_dom_1718_imput set setorcensitario = case when ltrim(rtrim(municipio)) = 'Alexânia' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 1 then cast(concat('52003080500000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),15,1)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Alexânia' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 2 then cast(concat('5200308050000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),14,2)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Alexânia' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 3 then cast(concat('520030805000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Cidade Ocidental' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 1 then cast(concat('52054970500000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),15,1)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Cidade Ocidental' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 2 then cast(concat('5205497050000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),14,2)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Cidade Ocidental' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 3 then cast(concat('520549705000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Cristalina' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 1 then cast(concat('52062060500000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),15,1)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Cristalina' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 2 then cast(concat('5206206050000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),14,2)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Cristalina' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 3 then cast(concat('520620605000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Formosa' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 1 then cast(concat('52080040500000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),15,1)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Formosa' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 2 then cast(concat('5208004050000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),14,2)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Formosa' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 3 then cast(concat('520800405000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Luziânia' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 1 then cast(concat('52125010500000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),15,1)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Luziânia' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 2 then cast(concat('5212501050000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),14,2)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Luziânia' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 3 then cast(concat('521250105000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Novo Gama' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 1 then cast(concat('52152310500000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),15,1)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Novo Gama' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 2 then cast(concat('5215231050000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),14,2)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Novo Gama' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 3 then cast(concat('521523105000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Santo Antônio do Descoberto' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 1 then cast(concat('52197530500000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),15,1)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Santo Antônio do Descoberto' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 2 then cast(concat('5219753050000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),14,2)) as bigint)
                                                             when ltrim(rtrim(municipio)) = 'Santo Antônio do Descoberto' and len(cast(substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3) as int)) = 3 then cast(concat('521975305000',substring(cast(ltrim(rtrim(setorcensitario)) as char(15)),13,3)) as bigint)
                                                        else null end
